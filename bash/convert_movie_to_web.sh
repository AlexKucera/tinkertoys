...
mp4_vcodec="-vcodec libx264 -pix_fmt yuv420p -vf scale='trunc(oh/a/2)*2:720' -g 30 -b:v 2000k -vprofile high -bf 0"
mp4_acodec="-strict experimental -acodec aac -ab 160k -ac 2"
ffmpeg -i "$fullpath" $mp4_acodec $mp4_vcodec -f mp4 "$dest_file_mp4"
webm_vcodec=" -pix_fmt yuv420p -vcodec libvpx -vf scale='trunc(oh/a/2)*2:720' -g 30 -b:v 2000k -vpre 720p -quality realtime -cpu-used 0 -qmin 10 -qmax 42"
